package com.googlecode.objectify.insight.util.test;
...
public class StackTraceUtilsTest {
	...
	public void nonEnhancedStackTraceShouldRemainTheSame() {
		assertThat(StackTraceUtils.removeMutableEnhancements(nonEnhanced), equalTo(nonEnhanced));
	}
	
	@Test
	public void enhancedStacktraceShouldHaveDynamicPartsRemoved() {
		assertThat(StackTraceUtils.removeMutableEnhancements(enhanced), equalTo(unEnhanced));
	}
